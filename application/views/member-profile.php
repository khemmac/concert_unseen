...
<div id="content-body" class="page-register page-profile">
	<?=$this->load->view('includes/inc-main-menu','', TRUE)?>

	<h3 style="text-align:center; font-family:'thaisans_neuebold';">แก้ไขข้อมูลส่วนตัว</h3>
	<div id="form">
		<?= form_open('', array('class'=>'form-profile form-horizontal')) ?>
		<?php
			$days = array();
			for($i=1;$i<=31;$i++)
				$days[$i] = $i;
			...
			$forms = array(
				...
				array(
					...
					'type'		=> 'password',
					'maxlength'	=> '50',
					'label'		=> get_label('password_old', $rules)
				),
				array(
					'name'		=> 'password_new',
					'type'		=> 'password',
					'maxlength'	=> '50',
					'label'		=> get_label('password_new', $rules)
				),
				array(
					'name'		=> 'question',
					'class'		=> 'input-xlarge',
			...
			form_helper_generate_bootstrap($forms, $form_db_value);
